...
function TechnicalInformationPage(props: {nlpResult: Result}) {
    ...
    const memoryUsage = getObjectSize(props.nlpResult)
    ...
    const data = [
        {
            ...
            value: `${props.nlpResult.metainfo.processingTime.toFixed(1)} ms`
        },
        {
